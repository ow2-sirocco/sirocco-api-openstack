 ...
 */
public class ConfirmResizeAction implements Action {

    public static final String ACTION = "confirmResize";
    ...
    public Response invoke(String serverId, JsonNode payload) {
        return computeFault("Not supported", 500, ACTION + " is not supported by the Sirocco API");
    }
}
